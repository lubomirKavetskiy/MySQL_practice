...
select * from pets;
alter table pets
change `species` `new_species` varchar(20);
...
DESCRIBE products;
INSERT INTO products (name, price, coffee_origin) VALUES ('Espresso', 3.2, 'Brazil');

INSERT INTO products (name, price, coffee_origin) VALUES ('Macchito', 3, 'Brazil'), ('Cappuchino', 3.5, 'Costa Rica'), ('Latte', 3.5, 'Indonesia'), ('Americano', 3, 'Brazil'), ('Flat White', 3.5, 'Indonesia'), ('Filter', 3, 'India');

-- update data in table
UPDATE products SET coffee_origin='Brasil_2' WHERE id=2;
...
UPDATE products SET coffee_origin='Columbia' WHERE coffee_origin='Brazil';
...
SELECT * FROM people;
INSERT INTO people(name, age, gender) VALUES('Emma', 21, 'F'),('Jhon', 32, 'M'), ('Thomas', 27, 'M');
DELETE from people WHERE name="Jhon";
DELETE from people;
DELETE from products WHERE coffee_origin="Brasil_2";
DELETE from products WHERE coffee_origin="Columbia";
INSERT INTO products (name, price, coffee_origin) VALUES ('Espresso', 3.2, 'Brazil');
